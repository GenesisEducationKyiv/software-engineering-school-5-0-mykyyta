...
const (
	...
	WeatherService_ValidateCity_FullMethodName = "/weather.WeatherService/ValidateCity"
)
...
type WeatherServiceClient interface {
	...
	ValidateCity(ctx context.Context, in *ValidateRequest, opts ...grpc.CallOption) (*ValidateResponse, error)
}
...
func (c *weatherServiceClient) ValidateCity(ctx context.Context, in *ValidateRequest, opts ...grpc.CallOption) (*ValidateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ValidateResponse)
	err := c.cc.Invoke(ctx, WeatherService_ValidateCity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WeatherServiceServer interface {
	...
	ValidateCity(context.Context, *ValidateRequest) (*ValidateResponse, error)
...
func _WeatherService_ValidateCity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WeatherServiceServer).ValidateCity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WeatherService_ValidateCity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).ValidateCity(ctx, req.(*ValidateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WeatherService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ValidateCity",
			Handler:    _WeatherService_ValidateCity_Handler,
		},
	},
