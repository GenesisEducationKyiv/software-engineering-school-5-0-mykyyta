...
type repo interface {
	GetByEmail(ctx context.Context, email string) (*domain2.Subscription, error)
	Create(ctx context.Context, sub *domain2.Subscription) error
	Update(ctx context.Context, sub *domain2.Subscription) error
	GetConfirmedByFrequency(ctx context.Context, frequency string) ([]domain2.Subscription, error)
}

type emailService interface {
	SendConfirmationEmail(email, token string) error
	SendWeatherReport(email string, weather domain2.Report, city, token string) error
}

type weatherService interface {
	GetWeather(ctx context.Context, city string) (domain2.Report, error)
...
func (s Service) Subscribe(ctx context.Context, email, city string, frequency domain2.Frequency) error {
...
func (s Service) ListConfirmedByFrequency(ctx context.Context, frequency string) ([]domain2.Subscription, error) {
